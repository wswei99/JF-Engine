...
//     }
//     // 渲染矩形块所在的区域
//     static renderWithViewAndRect(view, rect, needRenderprevView = true) {
...
//             return false;
//         }
//         if(needRenderprevView){
//             // 查看该区域下方的视图
//             let crossprevViewList = RenderCheck.findCrossViewWithViewAndRect(view, rect, 'pre');
//             // 视图下方一定有其他视图(最底部是stage)
//             // 合并该区域上下方所有需要渲染的视图
//             crossNextViewList = crossprevViewList.concat(crossNextViewList);
//         }
